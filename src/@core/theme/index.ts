...
// Inter font family (loaded via CSS)
const interFontFamily = '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif'
...
const theme = (settings: Settings, mode: SystemMode, direction: Theme['direction']): Theme => {
  return {
    ...
    typography: typography(interFontFamily),
