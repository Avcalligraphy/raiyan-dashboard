...
const Login = ({ mode }: { mode: Mode }) => {
  ...
  const lightIllustration =
    "/images/illustrations/auth/login-kakbah-ilustration.png";
  ...
  return (
    <div className="flex bs-full justify-center bg-white">
      ...
      <div className="flex justify-center items-center bs-full bg-backgroundPaper !min-is-full p-6 md:!min-is-[unset] md:p-12 md:is-[480px] border-l border-gray-200">
        <Link
          href="/"
